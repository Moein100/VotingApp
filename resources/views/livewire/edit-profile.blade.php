    ...
    <div class="flex items-end justify-center min-h-screen ">
      ...
      class="modal  bg-white rounded-tl-xl rounded-tr-xl  overflow-hidden shadow-xl transform transition-all py-4  sm:max-w-lg sm:w-full">
        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <h3 class="text-center text-lg font-bold text-gray-700">Edit Profile</h3>
          
          <form wire:submit.prevent="updateProfile" action="" method="POST" class="space-y-4 py-6">


            <div>
                <label class="block text-sm font-medium text-gray-700"> curren avatar </label>
                <div class="mt-1 flex items-center space-x-10">
                  ...
                  <label class="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" for="profileImg">Change</label>
                  @if($avatar)
                  <span class="inline-block h-12 w-12 rounded-full overflow-hidden bg-gray-100">
