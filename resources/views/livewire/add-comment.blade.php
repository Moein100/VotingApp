        ...
        <div
            ...
            <form wire:submit.prevent="addComment" action="#" class="space-y-4 px-4 py-6">
                ...
                <div class="flex flex-col md:flex-row items-center md:space-x-3">
                    ...
                    <div class="flex items-center justify-center w-1/2 h-11 text-xs bg-gray-200
                        ...
                        <label for="file2"  class="w-full h-full px-3 flex items-center"
                        >
                    ...
                    @if ($commentImage)
                    Photo Preview:
                    <img class="h-24 w-24" src="{{ $commentImage->temporaryUrl() }}">
                    @endif
            </form>
            @else
